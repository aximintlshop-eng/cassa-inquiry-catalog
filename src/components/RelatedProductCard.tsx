...
const RelatedProductCard = ({ id, name, image, category, shortDescription }: RelatedProductCardProps) => {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-md card-hover h-full flex flex-col">
      <Link to={`/product/${id}`} className="block overflow-hidden">
        <div className="h-40 overflow-hidden relative bg-gray-50 flex items-center justify-center p-2">
          <img 
            src={image} 
            alt={name} 
      ...
      <div className="p-4 pt-0 mt-auto flex gap-2">
        ...
        <a 
          href={`https://wa.me/1234567890?text=I'm%20interested%20in%20the%20product:%20${encodeURIComponent(name)}`}
          target="_blank" 
